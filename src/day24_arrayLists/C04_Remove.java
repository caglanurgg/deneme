...
public class C04_Remove {
    public static void main(String[] args) {
        ...
        // gittim Hasan diye bir isim bulamadim onun icinde silemedim

        System.out.println(isimler.remove("Kaan")); // true
        // gittim Kaan diye bir isim buldum  onun icinde sildim
        ...
        sayilar.remove(1);
        System.out.println(sayilar); // element olarak 1'i degil index olarak 1'i sildi
        // [3, 7, 1]
