...
public class C05_varOlanArrayeYeniDegerAtama {
    public static void main(String[] args) {
        ...
        // 7.elementi by array'e atayabilir miyiz?

        // arr[6] = 13; //ArrayIndexOutOfBoundsException

        arr =new int[8]; // 8 elementli bir array atamasi yaptik
        ...
        harfler =new String[] {"x"}; // eger liste seklinde eklemek istersek bu sekilde atama yapabiliriz

        System.out.println(Arrays.toString(harfler)); // [x]

        /*
        element atamasi yapamiyoruz ama  yeni bir array degeri atamasi yapabiliriz
         */
