...
import java.util.List;
    ...
    public class C01_CheckedExceptions {
        ...
        public static void main(String[] args) throws FileNotFoundException {
            /*
            onemli = main method'un yanina  -throws FileNotFoundException- yazilmissa bu su demek
            bu method calisirken FileNotFoundException olusma ihtimali var, haberiniz olsun
            throws keyword'unu kullanarak bekledigimiz exception'i yazmako exception'i handle etmek degildir.
            Java bir  problemle karsilasirsa yine sorun edecektir yine calismayi durdurur
            ama su anda calismaya engel olmaz
             */
