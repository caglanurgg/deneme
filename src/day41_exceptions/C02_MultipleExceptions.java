...
import java.util.Scanner;
  ...
  51.satir // InputMismatchException e'ı yakalarsan o zaman  System.out.println("Sizden sayi istedim"); bunu yazdir
  53.satir // eger onu yakalamaz  da StringIndexOutOfBoundsException e'i yakalarsan
           // o zaman System.out.println("Girilen index String'in sinirlari disinda"); yazdir
         ...
         */
            ...
            try {
                ...
                System.out.println(str.charAt(girilenIndex));
                System.out.println(arr[girilenIndex]);
            } catch (Exception e) { // eger bir RuntimeException ile karsilasirsan

                System.out.println("Kod calistirilirken bir hata ile karsilasildi"); // su islemi yap
                e.printStackTrace(); // hatayi yaz diyor (hatanin ne oldugunu yazdirmis oldum)
            }
     ...
     */
        ...
        /*
        ahmet hocadan notlar
        1) bir exception birden fazla exceptionla ugrasirken bunlarin arasinda da
        parent child iliskisi var mi diye bakmamiz  gerekiyor.
         */
    }
