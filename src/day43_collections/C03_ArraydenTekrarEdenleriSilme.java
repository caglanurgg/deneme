    ...
    public class C03_ArraydenTekrarEdenleriSilme {
        ...
        public static void main(String[] args) {
            ...
            for (int each:arr
                ...
                if (!tekrarsizList.contains(each)){ //tekrarsizList bu elementi icermiyorsa
                    tekrarsizList.add(each); // tekrarsizList'e bu elementi ekle
                }
            }
            ...
            } // kontrole gerek yok zaten set onu unique hale getirecek
            ...
            // [2, 4, 5, 6, 3, 4, 2, 1, 5, 6, 4, 3, 2, 3, 0, 1, 3, 4, 2, 5]
            ...
            // set'tekileri for each loop getirecek ama benim normal arr'e koyabilmem icin
            //index'e ihtiyacım var.
        }
    }
