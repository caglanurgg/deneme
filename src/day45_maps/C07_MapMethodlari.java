...
import java.util.Map;
    ...
    public class C07_MapMethodlari {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(harfler.getOrDefault("G", 0)); // 0 G'yi bulamadi
                                                                            // 0 getirdi

            System.out.println(harfler.getOrDefault("T", 0)); // 5 T'yi buldu

            System.out.println(harfler.get("G")); // null

            System.out.println(harfler.replace("F", 90));
            System.out.println(harfler); // null

            System.out.println(harfler.replace("T", 90)); // 5 getiriyor
            System.out.println(harfler); // {A=15, T=90, Z=50, K=25, L=40} 90'la  degistiriyor
