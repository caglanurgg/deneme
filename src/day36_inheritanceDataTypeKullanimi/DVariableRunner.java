...
public class DVariableRunner { // Variable olanlar ilk bulduğunu alıyor
    // data turu olan class'daki ortak ozellikleri alır

    public static void main(String[] args) {

        CAvciKuslar               avciKusKartal = new            CAvciKuslar();  // obje olusturma yontemi
        //class adı/ data türü       isim         new keyword     constructor

        //once constructor'a bakiyoruz. Aramaya class adı/data türünden baslıyacaksın

        System.out.println(avciKusKartal.hareket); // C  class'ından alır Ucarlar
        ...
        System.out.println(avciKusKartal.kanat); // B class'ından alır kanatlidir
        ...
        BKuslar kusKartal = new CAvciKuslar(); // constuctor

        System.out.println(kusKartal.hareket); // A hareket eder
        System.out.println(kusKartal.beslenme); // A beslenir
        // System.out.println(kusKartal.pence); // B veya A'da yok CTE asagı gitmez daima yukarı
        ...
        AHayvan hayvanKartal = new CAvciKuslar(); // constuctor
    ...
    /*
        ...
        objenin ozelliklerini DATA TURU belirler --> onemli
