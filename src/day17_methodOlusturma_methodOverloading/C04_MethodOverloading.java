...
public class C04_MethodOverloading {
    ...
    /*
     ...
     Java oncelikle METHOD İSMİNİ kontrol eder
     Sonra argument olarak verilen degerler ile,
     PARAMETRE olarak yazilan VARİABLE'larin data turlerini karsilastirir
  ...
  */
    ...
    public static void main(String[] args) {
        ...
        toplama(4.3,2.4); // iki double'in toplami :6.699999999999999

        toplama(3.4f,5); // double ve int'in toplami :8.400000095367432

        toplama(2.3f,5f); // iki double'in toplami :7.299999952316284

    } // main method sonu

    public  static void toplama(int sayi1, int sayi2) { // toplamaint int
    ...
    public static void toplama (double sayi1 , double sayi2) { // toplama double double (signature)
    ...
    method ismi + parametrelerin DATA TURLERINE method signature denir
        ...
        bunun avantajı ayni isimdeki methodla farklı farklı islemler yapabilme yetisi kazandirir
    */
