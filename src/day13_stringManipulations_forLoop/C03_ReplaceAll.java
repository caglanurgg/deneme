...
public class C03_ReplaceAll {
    public static void main(String[] args) {
        ...
        System.out.println("Lutfen istediginiz mesaji  giriniz");
        String metin = scanner.nextLine();

        // once sayilardan kurtulalim
       metin  =metin.replaceAll("\\d","");
       System.out.println(metin); // J*av.a C//an=+dir--_
        ...
        System.out.println(metin);  // Java1Candir_

        // space yerine atadigimiz 1'i yeniden space yapalim
        metin = metin.replaceAll("1"," ");
        System.out.println(metin);   // Java Candir_
