...
import java.util.TreeMap;
    ...
    public class MethodDeposu {
        ...
        public static Map<Integer,String> ogrenciMapOlustur(){ // METHOD
        ...
        public static void isimSoyisimListesiYazdir(Map<Integer,String> ogrenciMap){ // method
            ...
            ) {  // 2- bir for-each loop ile her bir value'yu ele alalim
        ...
        public static void sinifSubedekiOgrenciListesiYazdir(Map<Integer,String> ogrenciMap,int sinif,String sube){
            ...
            System.out.println("=================================");
            for (String eachValue:valueCollection // FOR EACH LOOP
            ) {
                ...
                if (valueArr[2].equals(sinifStr) && valueArr[3].equalsIgnoreCase(sube)){
                    ...
                    //***Eger(if) sinif ve sube parametre olarak verilen ile ayni ise
        ...
        public static void numaraliOgrenciListesiYazdir(Map<Integer,String> ogrenciMap){
            ...
            // 1- butun key'leri kaydedelim
            Set<Integer> ogrenciKeySeti = ogrenciMap.keySet(); // [101, 102, 103, 104, 105, 106]

            // 2- bir for each loop ile tum key'leri elden gecirebilirim
            for (Integer eachKey: ogrenciKeySeti
            ) {

                // 3- her bir key
                System.out.print(eachKey + " "); // HOCADA 103 AMA BENCE  101 OLMALI
        ...
        public static Map<Integer, String> yilSonuSinifArtir(Map<Integer, String> ogrenciMap) {
            ...
            // for-each loop ile her bir key'e ait value'yu cagirip,
            // istedigimiz update'i yapalim
            for (Integer eachKey: ogrenciKeySeti
            ) {

                //   1- bilgiye ulasmak icin yaptigimiz gibi adim adim
                //   value'yu array'e cevirmeliyiz
                ...
                //    2- bilgiye ulasmak icin parcaladigimiz value'yu yeni haliyle
                //    tekrar birlestiririz
